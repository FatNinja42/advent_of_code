package com.fatninja.aoc.d11.p2;

import java.io.IOException;

import static com.fatninja.aoc.d11.p2.Main.Direction.*;
import static com.fatninja.aoc.utils.MatrixUtils.*;

public class Main {

    public static void main(String[] args) throws IOException {
        char[][] configuration = readCharMatrixFromFile("src/resources/d11/input.txt");
